...
VALUES (73063, 'ace73063-viamontiandirelandsmine', 7, '2020-02-22 02:01:26') /* Portal */;
...
VALUES (73063,   1, True ) /* Stuck */
     , (73063,  12, True ) /* ReportCollisions */
     , (73063,  13, True ) /* Ethereal */
     , (73063,  14, True ) /* GravityStatus */
     , (73063,  15, True ) /* LightsStatus */
     , (73063,  19, True ) /* Attackable */
     , (73063,  88, True ) /* PortalShowDestination */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (73063,  54, -0.10000000149011612) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (73063,   1, 'Viamontian Direlands Mine') /* Name */
     , (73063,  37, 'givenesperminegem') /* QuestRestriction */
     , (73063,  38, 'Viamontian Direlands Mine') /* AppraisalPortalDestination */;
